...
export const ZEN_WORLDS = [
  ...
  { id: 2, name: 'Flow', tagline: 'Find your rhythm', color: '#14b8a6', icon: '◆' },
  { id: 3, name: 'Calm', tagline: 'Pure puzzle', color: '#0ea5e9', icon: '⬟' },
  { id: 4, name: 'Drift', tagline: 'Larger grids, no rush', color: '#6366f1', icon: '◇' },
