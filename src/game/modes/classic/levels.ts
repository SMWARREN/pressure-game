...
import { Level, Tile, Direction } from '../../types';
...

{
  ...
  maxMoves: 8,
  goalNodes: [{ x: 3, y: 1 }, { x: 1, y: 3 }, { x: 5, y: 3 }, { x: 3, y: 5 }, { x: 3, y: 3 }],
},
...

{
  ...
  maxMoves: 12,
  goalNodes: [{ x: 1, y: 1 }, { x: 4, y: 1 }, { x: 1, y: 4 }, { x: 4, y: 4 }],
},

{
  ...
  compressionDelay: 4000,
  maxMoves: 6,
  goalNodes: [{ x: 5, y: 5 }, { x: 5, y: 7 }, { x: 2, y: 3 }, { x: 3, y: 6 }, { x: 2, y: 7 }, { x: 3, y: 4 }],
}
];
