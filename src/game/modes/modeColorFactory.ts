...
export const modeColorPalettes = {
  ...
  zen: () => createModeColors({
    primary: '#34d399',      // emerald
    secondary: '#6ee7b7',
    success: 'rgba(34,197,94,0.5)',
  }),

  candy: () => createModeColors({
    primary: '#ec4899',      // pink
    secondary: '#f472b6',
  ...
  gravityDrop: () => createModeColors({
    primary: '#eab308',      // yellow
    secondary: '#facc15',
    nodeGlow: 'rgba(234,179,8,0.6)',
  }),

  fuse: () => createModeColors({
    primary: '#ef4444',      // red
    secondary: '#f87171',
    danger: 'rgba(239,68,68,0.6)',
  }),

  shoppingSpree: () => createModeColors({
    primary: '#8b5cf6',      // violet
    secondary: '#a78bfa',
    nodeGlow: 'rgba(139,92,246,0.6)',
  }),

  gemBlast: () => createModeColors({
  ...
  quantum_chain: () => createModeColors({
    primary: '#8b5cf6',      // violet
    secondary: '#a78bfa',
    pathActive: '#a78bfa',
    nodeGlow: 'rgba(139,92,246,0.6)',
