    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: '#2a2a3e', margin: '0 auto 20px',
        }} />
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: '#3a3a55', marginTop: 2 }}>Choose how you want to play</div>
          </div>
          <button
            onClick={onClose}
            style={{
              width: 32, height: 32, borderRadius: '50%', border: 'none',
              background: '#12122a', color: '#3a3a55', cursor: 'pointer',
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 3, alignItems: 'flex-end', flexShrink: 0 }}>
                  {mode.supportsUndo === false && (
                    <Badge label="No Undo" color="#ef4444" />
                  )}
                  {mode.wallCompression === 'never' && (
                    <Badge label="No Walls" color="#34d399" />
                  )}
                  {mode.wallCompression === 'always' && (
                    <Badge label="Walls On" color="#f97316" />
                  )}
                  {mode.useMoveLimit === false && (
                    <Badge label="Unlimited" color="#60a5fa" />
                  )}
                  {active && (
                    <Badge label="Active" color={mode.color} />
                  )}
                </div>
              </button>
            )
        ...
        {activeMode.wallCompression === 'optional' && (
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 13, color: '#3a3a55', fontWeight: 700 }}>Wall Compression</div>
              <div style={{ fontSize: 10, color: '#1e1e35', marginTop: 2 }}>Toggle walls on/off for this mode</div>
            </div>
            <Toggle
