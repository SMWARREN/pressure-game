...
class GameControllerTest extends TestCase
{
    ...
    public function testCreateSuccessSkipped(): void
    {
        // create() requires php://input stream which is hard to mock in unit tests
        $this->markTestSkipped('GameController->create() requires php://input stream.');
    }
}
